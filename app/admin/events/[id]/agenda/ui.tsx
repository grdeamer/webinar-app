              ...
              {!editing ? (
                <div className="mt-5">
                  ...
                  <div className="mt-6 grid grid-cols-2 gap-2">
                    ...
                    <button onClick={() => updateItem(selectedItem.id, { status: "upcoming" }, "Session reset to upcoming")} disabled={busy || selectedItem.status === "upcoming"} className="col-span-2 rounded-xl border border-sky-300/20 bg-sky-500/10 px-4 py-3 text-sm font-bold tracking-wide text-sky-100 hover:bg-sky-500/20 disabled:cursor-not-allowed disabled:opacity-35">RESET TO UPCOMING</button>
