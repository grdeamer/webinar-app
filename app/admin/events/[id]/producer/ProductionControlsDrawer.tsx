      ...
      <div className="min-h-0 flex-1 overflow-y-auto p-5">
        {activeTab === "audio" ? (
          ...
          <div className="grid grid-cols-[310px_minmax(360px,1fr)_180px_320px] gap-5">
            <section className="grid gap-3"><div className="rounded-xl border border-white/10 bg-white/[0.025] p-4"><div className="text-[16px] font-medium">Program Recording</div><div className="mt-1 text-[14px] text-white/65">1080p · 30 fps · Stereo</div></div><div className="rounded-xl border border-white/10 bg-white/[0.025] p-4"><div className="text-[16px] font-medium">Jupiter Cloud</div><div className="mt-1 text-[14px] text-emerald-300">Storage ready</div></div></section>
