...
export default function ActivityTreeClient({
  ...
  return (
    <div className="global-editorial-page activity-editorial-page mx-auto max-w-[1680px]">
      <header className="flex flex-col gap-6 border-b border-white/10 pb-7 lg:flex-row lg:items-start lg:justify-between">
        <div><h1 className="text-4xl font-semibold tracking-[-.045em] sm:text-5xl">Live activity</h1><p className="mt-3 text-base text-white/62">See where audiences are gathering across every active event.</p></div>
