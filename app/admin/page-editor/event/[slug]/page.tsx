  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="relative flex min-h-[calc(100vh-81px)]">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-10">
              {loading ? (
                ...
                <div className={canvasWrapClass}>
                  <div
                    ref={canvasRef}
                    className="relative mt-8 min-h-[900px] overflow-hidden rounded-2xl border border-white/10 bg-black"
                    onPointerDown={(e) => {
                      if (!isEditing) return
        ...
        <aside
          className={`shrink-0 border-l border-white/10 bg-slate-950/95 backdrop-blur-xl transition-[width,opacity] duration-300 ${
            isEditing ? "w-[380px] opacity-100" : "w-0 opacity-0"
          } ${!isEditing ? "pointer-events-none overflow-hidden" : "overflow-visible"}`}
        >
          <div className="h-full w-[380px] p-6">
            <div>
