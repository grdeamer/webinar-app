...
export default async function AdminSessionsPageEditorListPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
        ...
        <h1 className="mt-2 text-3xl font-bold">Sessions Page Preview</h1>
        <p className="mt-3 max-w-3xl text-white/70">
          Choose an event to open its sessions landing page in a dedicated preview tab.
        </p>
      </div>
