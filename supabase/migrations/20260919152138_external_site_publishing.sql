...
create index if not exists event_publish_deployments_event_idx
  on public.event_publish_deployments(event_id, created_at desc);
...
create index if not exists event_publish_deployments_created_by_idx
  on public.event_publish_deployments(created_by)
